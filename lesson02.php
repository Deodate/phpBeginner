<?php
	...
	*/
	...
	// exit();
	is_null($projectInstructor)?:print("hello");//two function is combined one is to ask if variable contain nothing within

	if(is_null($projectInstructor)?:print("is not null"))//combining if with function we seen
